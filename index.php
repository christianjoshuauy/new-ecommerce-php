    ...
    <main>
      <div class="hero-text">
        <div class="hero-start">
          ...
          <h4>three days</h4>
          <h4 class="paragraph-title">purchase now</h4>
          <hr>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut tristique lectus vel velit ullamcorper, ac laoreet orci mattis. Vestibulum euismod congue erat, id molestie lacus suscipit ut. Suspendisse potenti. Sed porttitor enim at gravida commodo. Morbi sit amet tristique elit, vitae euismod velit.</p>
